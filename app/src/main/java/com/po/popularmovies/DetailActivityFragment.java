...
public class DetailActivityFragment extends Fragment {
	...
	public View onCreateView (LayoutInflater inflater, ViewGroup container,
		...
		((TextView) rootView.findViewById(R.id.textView_releasedate)).setText(movie.getFormattedDate());
		((TextView) rootView.findViewById(R.id.textView_rating)).setText(movie.getFormattedRating());
